...
`ThreadPoolExecutor` to improve performance by running tasks concurrently.
...
class PSO:
    ...
    def pso(self) -> Tuple[np.ndarray, float]:
        ...
        # Use a ThreadPoolExecutor to evaluate particles in parallel
